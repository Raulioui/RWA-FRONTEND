...
export default function ThreeYearsChart({id}) {
    const [data, setData] = useState([]);
    const [domain, setDomain] = useState([])
    
    useEffect(() => {
        const fetchStockData = async (endDate, startDate) => {
        const res = await fetchAssetDataChart(id, endDate, startDate, "12Month", 3);
        ...
        startingDate.setDate(startingDate.getDate() - 1098); 
